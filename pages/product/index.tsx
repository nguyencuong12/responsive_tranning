  ...
  return (
    <Wrapper>
      ...
      <Grid>
        <Grid.Col md={6}>
          <ProductItem>
            <ProductImagePreviewTop>
              <div className="action-fullscreen">
                <ActionIcon
                  radius="xl"
                  variant="filled"
                  color={"red"}
                ...
                >
                  <ArrowsMaximize size={20}></ArrowsMaximize>
                </ActionIcon>
              </div>
            </ProductImagePreviewTop>
            <ProductImagePreviewBottom>
              <Grid>
                <Grid.Col md={3} sm={6}>
                  <ProductImagePreviewBottomItem>1</ProductImagePreviewBottomItem>
                </Grid.Col>
                <Grid.Col md={3} sm={6}>
                  <ProductImagePreviewBottomItem>1</ProductImagePreviewBottomItem>
                </Grid.Col>
