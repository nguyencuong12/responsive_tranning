...
const ShopPage = () => {
    return (
        <>
            <Head>
                <title>Hệ thống cửa hàng Gas anh kiệt ở quận hóc môn</title>
            </Head>
            <Wrapper>
                <Top>Hệ thống cửa hàng Gas Anh Kiệt (3 cửa hàng)</Top>
                <Bottom>
                    <Grid>
                        <Grid.Col md={8} className="bottom-item">
                            <iframe
                        ...
                        <Grid.Col md={4} className="bottom-item">
                            Bibo Mart Bạch Mai Số 290 Bạch Mai, P. Bạch Mai, Q. Hai Bà Trưng, Hà Nội
                        </Grid.Col>
                    </Grid>
                </Bottom>
            </Wrapper>
